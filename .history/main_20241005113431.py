...
@dp.message(AnnouncementStates.waiting_for_content, content_types=[ContentType.TEXT, ContentType.PHOTO])
async def process_announcement_content(message: Message, state: FSMContext):
    if message.content_type == ContentType.TEXT:
        ...
        await message.answer(f"<b>Предпросмотр вашего объявления:</b>\n\n{message.text}", reply_markup=get_confirmation_keyboard())
        ...
        await message.answer_photo(photo_id, caption=caption, reply_markup=get_confirmation_keyboard())
