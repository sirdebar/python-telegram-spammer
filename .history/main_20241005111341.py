...
async def start_bot(message: Message, state: FSMContext):
    ...
    if result:
        ...
        if member_status.status in ["member", "administrator", "creator"]:
            # Если подписан на канал
            if not is_subscribed:
                await update_subscription_status(user_id, True)  # Обновляем статус подписки в базе
            ...
            await update_subscription_status(user_id, False)  # Обновляем статус подписки в базе данных
