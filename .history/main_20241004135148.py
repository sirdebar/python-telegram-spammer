...
async def start_mailing(account_id, chats, messages, delay, user_id):
    """Запуск рассылки сообщений с фото или текстом."""
        ...
        for chat_id in chats:
            ...
            try:
                ...
                if messages['type'] == 'text':
                    await client.send_message(chat_id, messages['text'])
                elif messages['type'] == 'photo':
                    await client.send_file(chat_id, messages['photo'], caption=messages['caption'])
