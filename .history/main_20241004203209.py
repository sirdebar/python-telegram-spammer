...
async def cancel_deletion(callback_query: CallbackQuery):
    """Отменяем удаление и возвращаем в меню управления аккаунтами"""
    await callback_query.message.edit_text("<b>Удаление аккаунта отменено.</b>", reply_markup=get_user_menu())
