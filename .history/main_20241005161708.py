...
async def start_bot(message: Message, state: FSMContext):
    ...
    if result:
        ...
        sent_message = await message.answer("<b>Для использования бота, подпишитесь на канал, а так же прочтите и согласитесь с пользовательским соглашением.</b>", reply_markup=get_subscription_keyboard())
