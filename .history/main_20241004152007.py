...
# ================== ОТПРАВКА ПРЕМИУМ ЭМОДЗИ ===================

# Пример текста с премиум эмодзи
premium_text = "Привет! 😎🚀🔥"  # Это текст с премиум эмодзи
await client.send_message(chat, premium_text, parse_mode='html')
